...
import { useVirtualScenesColumns } from './virtual-scenes-columns'

type VirtualScenesTableProps = {
  data: VirtualScene[]
...
export function VirtualScenesTable({
  data,
  search,
  navigate,
  paginationMeta,
}: VirtualScenesTableProps) {
  ...
  const columns = useMemo(() => useVirtualScenesColumns(t), [t])
